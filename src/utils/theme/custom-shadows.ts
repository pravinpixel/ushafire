...
export function customShadows(theme: Theme): CustomShadow {
	...
	return {
		...
		card: `0 0 2px 0 ${alpha(theme.palette.grey[500], 0.08)}, 0 12px 24px -4px ${alpha(
			theme.palette.grey[500],
			0.08
		)}`,
		dropdown: `0 0 2px 0 ${alpha(theme.palette.grey[500], 0.24)}, -20px 20px 40px -4px ${alpha(
			theme.palette.grey[500],
			0.24
		)}`,
