...
export default function CardView({
  ...
  const handleCheckState = () => {
    return (
      user?.id !== viewTask?.assigned_by ||
      (params?.tab === "my_task" && viewTask?.is_self_assign === 1)
    );
  };
  ...
  const showAllButtons =
    !handleCheckState() && taskStatus?.toLowerCase() === "inprogress";
  ...
  return (
    <>
      ...
      >
        ...
        {viewTask ? (
          ...
          >
            ...
            <Stack direction={"column"} mt={1} flexWrap={"wrap"}>
              <Typography
                variant="f12"
              ...
              <Stack direction={"row"} gap={"16px"} mt={1}>
            ...
            <Stack direction={"row"} display={"block"} marginTop={2}>
              <Typography
                variant="f12"
                sx={{
                  color: "rgba(5, 5, 5, 1)",
            ...
            <Box display="flex" gap={2}>
              {viewTask?.documents?.map((doc) => (
                <UploadDocs document={doc} key={doc?.id} />
              ))}
            </Box>
            ...
            >
...

              {
                ...
                // 	/>
                // ) :
                taskStatus?.toLowerCase() === "inprogress" &&
                viewTask?.mark_as_completed === 1 ? (
                  // <CustomButton
                  // 	loading={false}
                  // 	label={"Mark as Completed"}
                  // 	startIcon={
                    ...
                    >
                      ...
                      <CustomButton
                        ...
                        startIcon={
                          ...
                          //     height={12}
                          //   />
                          <CloseIcons sx={{ width: 16, height: 16 }} />
                        }
                        sx={{
                          color: "#373737",
                          backgroundColor: "#FFFFFF",
      ...
      >
        <CardComments taskView={viewTask as never} id={id} />
      </Box>
      ...
      {open === "my-task" ? (
        ...
        >
          ...
          <CompletedTask handleClose={handleClose} id={id} />
        </Dialog>
      ) : (
        open === "self-task" && (
          <CompletePopUp
