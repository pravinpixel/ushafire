...
const UserTableContent = ({
  ...
  return (
    ...
    >
      <Typography
        variant="f12"
        sx={{ fontWeight: fontWeightBold, lineHeight: "20px" }}
  ...
  return (
    <>
      <Stack>
        ...
        <UserTableContent
          label={"Designation"}
          value={profileView?.designation?.name}
        />
      </Stack>
    </>
  );
              ...
              startIcon={
                <>
                  {isLoading ? (
                    ...
                    // <img src={logout1} alt="logout" width="18" height="18" />
                    <LogoutWhitecons sx={{ width: 18, height: 18 }} />
                  )}
                </>
              }
            />
          ...
          >
            <Stack direction={"row"} alignItems={"center"} display={"flex"}>
              {/* <Box
							onClick={handleClose}
						>
							<img alt="arrow-left" src={Left} width={24} height={24}/>
						</Box> */}
              <DialogTitle
                color="#88344C"
                sx={{
            ...
            <ChangePassword handleClose={handleCloses} />
          </Dialog>
        )}
      </Container>
    </>
