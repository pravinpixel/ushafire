  ...
  const menuItems: MenuItemData[] = [
    {
      ...
      children:
        data?.data?.["task-category"]?.map((category) => ({
          title: category.name,
      ...
      <Popper
        ...
        sx={{
          ...
          "& .MuiPaper-root": {
            ...
            boxShadow:
              "rgba(158, 158, 158, 0.2) 0px 5px 5px -3px, rgba(158, 158, 158, 0.14) 0px 8px 10px 1px, rgba(158, 158, 158, 0.12) 0px 3px 14px 2px;",
            borderRadius: "6px",
          },
        }}
      >
