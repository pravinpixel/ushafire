...
const BusinessVerticalList: React.FC<ComponentProps> = ({ permission }) => {
  const [params, setParams] = useState<PaginationInterFace>(InitialPagniationParams);
  const url = `/business-vertical`;
...
export default BusinessVerticalList;
