...
const SubVerticalList: React.FC<ComponentProps> = ({ permission }) => {
  const [params, setParams] = useState<PaginationInterFace>(InitialPagniationParams);
  const url = '/sub-vertical';
  ...
  return (
    <MasterTable
      ...
      setParams={setParams}
      isLoading={isLoading}
      buttonLabel="Sub Vertical"
      fieldLabel="Sub Vertical"
      visbleColumn={{
        vertical_id: true,
      }}
...
export default SubVerticalList;
