...
const UserTaskContent = ({ data }: { data?: LoginType }) => {
	...
	return (
		...
		>
			...
			<Typography variant={"f12"} lineHeight={'16.2px'} mt={0.4}>You’ve made it halfway! Keep going strong</Typography>
		</Stack>
	);
};
		...
		>
			<Stack alignItems="center">
				<img
					...
					height="46"
				></img>
				<Typography variant="f20" lineHeight={'25.27px'}>Task Master</Typography>
			...
			<Box sx={{display:'flex',justifyContent:'flex-end',alignItems:'flex-end',width:'100%'}} onClick={handleOpen} mt={1}>
				<Typography variant="f16"  textAlign={'end'} sx={{textDecoration:'underline',cursor:'pointer'}} lineHeight={'20px'} fontWeight={500}>Change password</Typography>
			</Box>
